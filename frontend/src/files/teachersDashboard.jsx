    ...
    return (
        <div class="blue-box" style={{width:864}}>
            <div>
                ...
                <span className="heading3"><u>deeppanchani@iiitn.ac.in</u></span>
            </div>
            <div>
                <h1 style={{margin:30}}>Feedback Responses</h1>
                <div className="blue-box grid_container" style={{width:671, height:148, marginTop:"auto", marginBottom:20, padding:0}}>

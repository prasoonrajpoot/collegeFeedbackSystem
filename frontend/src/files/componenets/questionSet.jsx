...
function Question(props) {
  ...
  return (
    <div>
      <label class="heading3" htmlFor="q1">
        Q{ind + 1}. {question}{" "}
      </label>
      <br />
...
function QuestionSet(props) {
  ...
  return (
    <div
      style={{ width: 864, margin: "auto", marginTop: 10, marginBottom: 20 }}
    >
      <form action="">
        <h1>

    ...
    <div style={{width:864, margin:"auto", marginTop:10, marginBottom:20}}>
        <form action="">
            ...
            <span class="star-cb-group">
              ...
              <input type="radio" id="rating-23" name="rating2" value="3" /><label for="rating-23">3</label>
              <input type="radio" id="rating-22" name="rating2" value="2" /><label for="rating-22">2</label>
              <input type="radio" id="rating-21" name="rating2" value="1" /><label for="rating-21">1</label>
            ...
            <span class="star-cb-group">
              ...
              <input type="radio" id="rating-32" name="rating3" value="2" /><label for="rating-32">2</label>
              <input type="radio" id="rating-31" name="rating3" value="1" /><label for="rating-31">1</label>
            ...
            <span class="star-cb-group">
              ...
              <input type="radio" id="rating-43" name="rating4" value="3" /><label for="rating-43">3</label>
              <input type="radio" id="rating-42" name="rating4" value="2" /><label for="rating-42">2</label>
              <input type="radio" id="rating-41" name="rating4" value="1" /><label for="rating-41">1</label>
            ...
            <span class="star-cb-group">
              ...
              <input type="radio" id="rating-53" name="rating5" value="3" /><label for="rating-53">3</label>
              <input type="radio" id="rating-52" name="rating5" value="2" /><label for="rating-52">2</label>
              <input type="radio" id="rating-51" name="rating5" value="1" /><label for="rating-51">1</label>
            ...
            <span class="star-cb-group">
              ...
              <input type="radio" id="rating-63" name="rating6" value="3" /><label for="rating-63">3</label>
              <input type="radio" id="rating-62" name="rating6" value="2" /><label for="rating-62">2</label>
              <input type="radio" id="rating-61" name="rating6" value="1" /><label for="rating-61">1</label>
            ...
            <span class="star-cb-group">
              ...
              <input type="radio" id="rating-73" name="rating7" value="3" /><label for="rating-73">3</label>
              <input type="radio" id="rating-72" name="rating7" value="2" /><label for="rating-72">2</label>
              <input type="radio" id="rating-71" name="rating7" value="1" /><label for="rating-71">1</label>
            ...
            <span class="star-cb-group">
              ...
              <input type="radio" id="rating-83" name="rating8" value="3" /><label for="rating-83">3</label>
              <input type="radio" id="rating-82" name="rating8" value="2" /><label for="rating-82">2</label>
              <input type="radio" id="rating-81" name="rating8" value="1" /><label for="rating-81">1</label>
            ...
            <span class="star-cb-group">
              ...
              <input type="radio" id="rating-93" name="rating9" value="3" /><label for="rating-93">3</label>
              <input type="radio" id="rating-92" name="rating9" value="2" /><label for="rating-92">2</label>
              <input type="radio" id="rating-91" name="rating9" value="1" /><label for="rating-91">1</label>
            ...
            <span class="star-cb-group">
              ...
              <input type="radio" id="rating-103" name="rating10" value="3" /><label for="rating-103">3</label>
              <input type="radio" id="rating-102" name="rating10" value="2" /><label for="rating-102">2</label>
              <input type="radio" id="rating-101" name="rating10" value="1" /><label for="rating-101">1</label>
            ...
            <span class="star-cb-group">
              ...
              <input type="radio" id="rating-113" name="rating11" value="3" /><label for="rating-113">3</label>
              <input type="radio" id="rating-112" name="rating11" value="2" /><label for="rating-112">2</label>
              <input type="radio" id="rating-111" name="rating11" value="1" /><label for="rating-111">1</label>
            ...
            <span class="star-cb-group">
              ...
              <input type="radio" id="rating-123" name="rating12" value="3" /><label for="rating-123">3</label>
              <input type="radio" id="rating-122" name="rating12" value="2" /><label for="rating-122">2</label>
              <input type="radio" id="rating-121" name="rating12" value="1" /><label for="rating-121">1</label>
